...
public class Cli {
     ...
     * 
     * @param terminal
     *            The terminal to use, can be Telnet, Rs232, Cmd or SSH
     *
     ...
     * 
     * @param timeout
     *            the time after which a timeout exception will be thrown
     * @throws InterruptedException
     * @throws Exception
     */
     ...
     *            the time after which a timeout exception will be thrown
     * @param delayedTyping
     *            if True then terminal buffer reading will be delayed (20 ms
     *            sleep between each byte)
     * @throws InterruptedException
     * @throws Exception
     */
    ...
    /**
     * Sends the command without waiting to any prompt. If delayedTyping is
     * true, sends each byte desperately + small wait after each byte.
     * 
     * @throws InterruptedException
     */
    ...
    /**
     * Returns the prompt which identification triggered the termination of the
     * cli operation.
     */
     ...
     *            Command text.
     * @param timeout
     *            Command timeout in miliseconds
     * @param addEnter
     *            If true enterString will be add to the command.
     * 
     * @exception IOException
     * @throws InterruptedException
     */
     ...
     *            Command timeout in miliseconds
     * @param addEnter
     *            If True, defined enter string will be added to the command.
     * 
     * @exception IOException
     * @throws InterruptedException
     */
    public void command(String command, long timeout, boolean addEnter, boolean delayedTyping)
     ...
     *            sleep between each byte)
     * @param promptString
     *            a Prompt String to wait for (if null then default terminal
     ...
     *            If True, defined enter string will be added to the command.
     * @param delayTyping
     *            if True then terminal buffer writing will be delayed (20 ms
     *            sleep between each byte)
     * @param promptStrings
     *            an array of all Prompt Strings that should be found (if null
     *            then default terminal prompts will be used)
     * @throws InterruptedException
     * @throws Exception
     */
     ...
     *            the command to send
     * @param timeout
     *            the time to wait for a Prompt before throwing a timeout
     *            exception
     * @param addEnter
     *            if True will add the predefined enter string to the command
     *            before sending
     * @param delayedTyping
     *            if True will sleep 20 ms between each typed byte sent to the
     *            terminal
     * @param promptStrings
     *            if not null then wait for <b>ALL</b> Strings in the given
     *            Array to be found in the terminal
     * @param prompts
     *            if promptStrings is null, wait for ONE of the prompts, if any
     *            exists
     * @throws InterruptedException
     * @throws Exception
     */
    public void command(String command, long timeout, boolean addEnter, boolean delayedTyping, String[] promptStrings,
	    Prompt[] prompts) throws IOException, InterruptedException {
    ...
    /**
     * Check if working in graceful mode. If true will send ENTER if prompt wait
     * fail
     * 
     * @param timeout
     *            the timeout to wait
    ...
    /**
     * set the terminal enter string (used when sending command or for graceful
     * wait)
     * 
     * @param enterStr
     *            the enter String (default is "\r")
     */
    ...
    /**
     * if set to True then enter String will be sent after Timeout was
     * reached.<br>
     ...
     *            if set to true will skip prompt waiting
     */
