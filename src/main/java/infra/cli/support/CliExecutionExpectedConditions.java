...
import infra.assertion.FailSafeAssertionListener;
...
public abstract class CliExecutionExpectedConditions {
    ...
    public static CliExecutionExpectedCondition<String> executionLogicHappens(
	    final AbstractAssertionLogic<String> logic) {
	return new CliExecutionExpectedCondition<String>() {
	    @Override
	    public String apply(CliCommandExecution execution) {
		try {
	...
	return new CliExecutionExpectedCondition<T>() {
		...
		try {
			...
			throw new NullPointerException(
				execution.toString() + " result parsed to null\n" + execution.getResult());
		    }
		    return actual;
		} catch (Exception e) {
