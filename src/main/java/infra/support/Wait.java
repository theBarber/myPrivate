 ...
 *
 * @param <F>
 *            the argument to pass to any function called
 */
public interface Wait<F> {
     ...
     * idiomatic for a given test infrastructure (e.g. JUnit4 would throw
     * {@link AssertionError}.
     *
     * @param <T>
     *            the return type of the method, which must not be Void
     * @param isTrue
