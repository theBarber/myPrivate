...
public class SshAgentRunner {
	...
	// SshAgent("src\\test\\resources\\user_info.properties");
	// String command1 = StringEscapeUtils.
	// escapeJava("cat /var/log/ramp-lift-ad-selector/ad-selector.log.1
	// /var/log/ramp-lift-ad-selector/ad-selector.log > temp_logs");
	// String command2 = StringEscapeUtils.escapeJava("tac temp_logs | egrep
	// -m1 Loaded | egrep -o solver_plan_[_[:alnum:]]+\\.json >
	// res_log.txt");
