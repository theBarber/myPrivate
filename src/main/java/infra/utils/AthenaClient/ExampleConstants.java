...
//    public static final String ATHENA_SAMPLE_QUERY = "select request_id, max(request_time_ms) " +
//            "FROM dl_raw_data.fact_dam_requests where request_time_ms > date_parse('2019-09-09', '%Y-%m-%d')  group by request_id ";
