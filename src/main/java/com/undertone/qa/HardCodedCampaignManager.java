...
//	this.createBanner("Test Banner", 17, campaign2.getId());
	...
	// // Banner banner968381 =
	// this.createBanner("Int-test-unlimited-banner", 968381,
	// campaign4.getId()).get();
	// // Banner banner968382 =
	// this.createBanner("Int-test-FF-targeted-banner", 968382,
	// campaign5.getId()).get();
	// // Banner banner968380 =
	// this.createBanner("Int-test-CH-targeted-banner", 968380,
	// campaign6.getId()).get();
	// // Banner banner968474 =
	// this.createBanner("Int-test-IE-targeted-banner", 968474,
	// campaign7.getId()).get();
	// // Banner banner968473 =
...
//	ZoneSet zoneSet719 = this.createZoneSet("hwu zonesets", 719, campaign2.getId()).get();
	...
	// Media", 50161, emptyCampaign.getId())
	// .get();
	//
	// ZoneSet zoneSet55023 = this.createZoneSet("zoneset55023", 55023,
	// campaign3.getId()).get();
	//
	// ZoneSet zoneSet21808 = this.createZoneSet("zoneset21808", 21808,
	// campaign4.getId()).get();
...
//	this.createZone("qa.undertone.com - Half Banner", 3, zoneSet719.getId()).get();
	...
	// // Zone zone144960 =
	// this.createZone("INT3132 - Billboard 970x250 - TEST_1", 144960,
	// zoneSet55023.getId()).get();
	// // Zone zone37750 =
	// this.createZone("QA-INT03 - Half Page Ad 300x600 - INT03AFP - Half
	// Page Ad", 37750, zoneSet21808.getId()).get();
	// // Zone zone11457 =
	// this.createZone("QA-INT01 - Half Page Ad 300x600 - INT01N - Half Page
	// Ad (300 x 600)", 11457,
	// zoneSet21808.getId()).get();
	// // Zone zone21694 =
	// this.createZone("QA-INT1961 - Half Page Ad", 21694,
	// zoneSet21808.getId()).get();
