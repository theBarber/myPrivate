...
public class HardCodedCampaignManager extends CampaignManager {
	...
	ZoneSet zoneSet50161 = this
		.createZoneSet("IO 58815 - HBO Series - HBO The Brink - Billboard Media", 50161, emptyCampaign.getId())
		.get();
	...
	// Zone zone11457 =
	this.createZone("QA-INT01 - Half Page Ad 300x600 - INT01N - Half Page Ad (300 x 600)", 11457,
