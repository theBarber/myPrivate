...
public class Assert extends org.junit.Assert {
	...
	assertLogic(resource, actualValueGenerator, logic, new DefaultAssertionListener<A>(), timeout, timeoutUnit,
     ...
     */
    static public <A, R> void assertLogic(R resource, final Function<R, A> actualValueGenerator,
	    AbstractAssertionLogic<A> logic, AssertionListener<A> listener, long timeout, TimeUnit timeoutUnit,
