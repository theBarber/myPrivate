...
import com.undertone.automation.assertion.DefaultAssertionListener;
...
import com.undertone.automation.module.AbstractModule;
			...
			if (cliConnection instanceof AbstractModule) {
				...
				if (errors != null && !errors.isEmpty()) {
					for (final String error : errors) {
					    Assert.assertThat(cliModule.getActual(String.class), Matchers.not(Matchers.containsString(error)));
					}
				}
			}
		}
