...
Feature: Supply type flow support
  ...
  Scenario: verify when HB first
    ...
    Then i send 1 times Dynamic Tag synchronized ad request with tag id 228 to UAS for publisher 3719 with domain {testing.com&unlimited=1}
  ...
  Scenario: verify when Direct first
    ...
    Then i send 1 times Dynamic Tag synchronized ad request with tag id 229 to UAS for publisher 3719 with domain {testing.com&unlimited=1}
  ...
  Scenario: verify when All first
    ...
    Then i send 1 times Dynamic Tag synchronized ad request with tag id 231 to UAS for publisher 3719 with domain {testing.com&unlimited=1}
