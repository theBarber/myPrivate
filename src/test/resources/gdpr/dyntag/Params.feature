...
Feature: GDPR - Zone Reqs - Europe Delivery Logic - Both Params Are Specified
  ...
  Scenario: gdpr=1 and gdprstr=UT_ID_INCLUDED_AND_PURPOSE_EXCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=1} for gdpr entities to UAS and with gdprstr which includes ut vendor id and excludes ut purpose ids
  ...
  Scenario: gdpr=1 and gdprstr=UT_ID_EXCLUDED_AND_PURPOSE_INCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=1} for gdpr entities to UAS and with gdprstr which excludes ut vendor id and includes ut purpose ids
    Then I expect gdpr passback
  ...
  Scenario: gdpr=1 and gdprstr=UT_ID_EXCLUDED_AND_PURPOSE_EXCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=1} for gdpr entities to UAS and with gdprstr which excludes ut vendor id and excludes ut purpose ids
    Then I expect gdpr passback
  ...
  Scenario: gdpr=1 and gdprstr=empty_string - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=1} for gdpr entities to UAS with an empty gdprstr
    Then I expect gdpr passback
  ...
  Scenario: gdpr=0 and gdprstr=UT_ID_INCLUDED_AND_PURPOSE_INCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=0} for gdpr entities to UAS and with gdprstr which includes ut vendor id and includes ut purpose ids
    Then I expect delivery
  ...
  Scenario: gdpr=0 and gdprstr=UT_ID_INCLUDED_AND_PURPOSE_EXCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=0} for gdpr entities to UAS and with gdprstr which includes ut vendor id and excludes ut purpose ids
    Then I expect delivery
  ...
  Scenario: gdpr=0 and gdprstr=UT_ID_EXCLUDED_AND_PURPOSE_INCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=0} for gdpr entities to UAS and with gdprstr which excludes ut vendor id and includes ut purpose ids
    Then I expect delivery
  ...
  Scenario: gdpr=0 and gdprstr=UT_ID_EXCLUDED_AND_PURPOSE_EXCLUDED - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=0} for gdpr entities to UAS and with gdprstr which excludes ut vendor id and excludes ut purpose ids
    Then I expect delivery
  ...
  Scenario: gdpr=0 and gdprstr=empty_string - zone request from eu
    Given I add {UK} ip header
    And I send 1 times an ad request with parameter {gdpr=0} for gdpr entities to UAS with an empty gdprstr
    Then I expect delivery
