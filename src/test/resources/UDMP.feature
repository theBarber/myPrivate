...
Feature: UDMP TESTS = profile targeting, seq targeting, cross decice capping
  ...
  Scenario: cross device capping for udmp,zone req when capping = 2, cross device capping = true - PART ONE - Delivery
  ...
  Scenario: cross device capping for udmp,zone req when capping = 2, cross device capping = true - PART TWO - Delivery
    Given I clear all cookies from uas requests
  ...
  Scenario: cross device capping for udmp,zone req when capping = 2, cross device capping = true - PART THREE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, from app - PART ONE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, from app - PART TWO - Delivery
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, from app - PART THREE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, with cookie - PART ONE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, with cookie - PART TWO - Delivery
    Given I clear all cookies from uas requests
  ...
  Scenario: profile targeting for udmp, zone req, with cookie - PART THREE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: Seq-targeting for udmp, DT req, with deviceid - PART ONE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: Seq-targeting for udmp, DT req, with deviceid - PART TWO - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: Seq-targeting for udmp, DT req, with deviceid - PART THREE - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: Seq-targeting for udmp, DT req, with deviceid - PART FOUR - Delivery
    Given I clear all cookies from uas requests
...
#  UTID=a2b3c8faf45446dcbba3248cef1dc2bb is encoded to=9mrjt7trg1a57yd4pv1i3ltbv
  Scenario: profile seq targeting for udmp, DT req, from desktop - PART ONE - Delivery
    Given I clear all cookies from uas requests
...
#  UTID=a9b8c7faf65436dcbba3248cef1dc2bb is encoded to=a1q4r5t1dt2193lzjjoz7kmnv
  Scenario: profile seq targeting for udmp, DT req, from desktop - PART TWO - Passback
    Given I clear all cookies from uas requests
...
#  UTID=a9b1c7faf25436dcbba3248cef1dc2bb is encoded to=a1o1866gg3j3ulsj9omeyfhyz
  Scenario: profile seq targeting for udmp, DT req, from desktop - PART THREE - Passback
    Given I clear all cookies from uas requests
...
#  UTID=a9b1c8faf27436dcbba3248cef1dc2bb is encoded to =a1o19osvf0w6rfwepq3avxy9n
  Scenario: profile seq targeting for udmp, DT req, from desktop - PART FOUR - Passback
    Given I clear all cookies from uas requests
  ...
  Scenario: line item level frequency capping persona level - Mixed
