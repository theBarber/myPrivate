...
##UTID=a2b3c8faf45446dcbba3248cef1dc2bb is encoded to=9mrjt7trg1a57yd4pv1i3ltbv
  ...
  Scenario: Seq-targeting for udmp, DT req, from app
    ...
    Then i send 1 times Dynamic Tag ad request to UAS for publisher 3708 with extra params {www.daniella.com&deviceid=00000006-0006-0006-0006-000000000006&tagid=297&unlimeted=0}
    Then The response code is 200
    And The responses are passback
    ...
    Then i send 1 times Dynamic Tag ad request to UAS for publisher 3708 with extra params {www.daniella.com&deviceid=60000006-6006-6006-6006-600000000006&tagid=297&unlimeted=0}
    Then The response code is 200
    And The responses are passback
    ...
    Then i send 1 times Dynamic Tag ad request to UAS for publisher 3708 with extra params {www.daniella.com&deviceid=60000006-6006-6006-6006-600000000000&tagid=297&unlimeted=0}
    Then The response code is 200
    And The responses are passback
