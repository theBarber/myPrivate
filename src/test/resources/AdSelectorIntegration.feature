...
Feature: UAS Integration with Ad Selector
	...
	|{"buying_strategy_id": -1, "slices": [{"banner_id": 968381, "weight": 1000000, "slice_id": "$SLICE_ID$", "start_time": 1477872001, "zone_id": 11457, "end_time": 1477958399, "predicates": {"AND": [{"==": ["body.features.zone_id", 11457]}, {"==": ["body.features.dma", 100]}]}, "buy_at_most": 10}]}   |
