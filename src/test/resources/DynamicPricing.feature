Feature: Dynamic pricing
  Scenario: HB Dynamic-Pricing for Direct - control and optimize flow
    Given i send 1 headerBidding post request for scenario {Send HB request with 1X1,1X2 size for publisher 3673} for publisher 3673 with domain {headerbiddingproptest.com} with extra params {&unlimited=1&optimize=0}
