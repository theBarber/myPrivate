...
#    Then I inject profile doc for scenario {Scenario 2} to users bucket
#    And I sleep for 3 seconds
#    Given I clear all cookies from uas requests
#    Given I Delete req logs
...
#    Then I inject profile doc for scenario {Scenario 2.1} to users bucket
#    And I sleep for 3 seconds
#    Given I clear all cookies from uas requests
#    Given I Delete req logs
#    When I send 1 times an ad request with parameter {bundleid=daniellaAppPLT&deviceid=12345600-0000-0000-0000-000000000123} for zone named {zone-zoneset-PLT-YesPersonaL-ST-1} to UAS
...
#    Then I inject profile doc for scenario {Scenario 4.1} to users bucket
#    And I sleep for 3 seconds
#    Given I clear all cookies from uas requests
