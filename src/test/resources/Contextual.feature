...
Feature: contextual targeting tests
  ...
  Scenario:1.0 contextual targeting by dv - inapp - PART ONE - Delivery Expected
  ...
  Scenario:1.0 contextual targeting by dv - inapp - PART TWO - Passback Expected
  ...
  Scenario:3.0 contextual targeting by dv - campaign level limitation domain exclude - PART TWO - Passback Expected
  ...
  Scenario:3.0 contextual targeting by dv - campaign level limitation domain exclude - PART THREE - Passback Expected
  ...
  Scenario:4.0 contextual targeting by dv - campaign level limitation - PART TWO - Passback Expected
  ...
  Scenario:4.0 contextual targeting by dv - campaign level limitation - PART THREE - Passback Expected
  ...
  Scenario:4.0 contextual targeting by dv - campaign level limitation - PART FOUR - Passback Expected
    When I send 1 times an ad request with parameter {optimize=1&loc=notarealweblala.com} for zone named {zone-zoneset-dv-campaignLevelLimit-ST} to UAS
    And The response code is 200
    And The responses are passback
  ...
  Scenario:5.0 contextual targeting - peer 39 banner level limitation backward compatibility - PART TWO - Delivery Expected
  ...
  Scenario:5.0 contextual targeting - peer 39 banner level limitation backward compatibility - PART THREE - Passback Expected
  ...
  Scenario:6.0 contextual targeting - peer 39 banner level limitation - PART ONE - Delivery Expected
    When I send 1 times an ad request with parameter {optimize=1&loc=http://www.cnn.com} for zone named {zone-zoneset-CT-ST-1} to UAS
    And The response code is 200
    And The response contains {script}
    And The impressionUrl has bannerid field matching the id of the banner named {campaign-CT-ST-1-banner-1} 100% of the time

  Scenario:6.0 contextual targeting - peer 39 banner level limitation - PART TWO - Passback Expected
    When I send 1 times an ad request with parameter {optimize=1&loc=notarealweblala.com} for zone named {zone-zoneset-CT-ST-1} to UAS
    And The response code is 200
    And The responses are passback

  Scenario:7.0 contextual targeting by dv - zone level limitation - PART ONE - Delivery Expected
  ...
  Scenario:7.0 contextual targeting by dv - zone level limitation - PART TWO - Passback Expected
  ...
  Scenario:7.0 contextual targeting by dv - zone level limitation - PART THREE - Passback Expected
  ...
  Scenario:7.0 contextual targeting by dv - zone level limitation - PART FOUR - Passback Expected
  ...
  Scenario:8.0 contextual targeting by dv & peer 39 - zone level limitation - PART ONE - Delivery Expected
  ...
  Scenario:8.0 contextual targeting by dv & peer 39 - zone level limitation - PART TWO - Passback Expected
  ...
  Scenario:8.0 contextual targeting by dv & peer 39 - zone level limitation - PART THREE - Passback Expected
  ...
  Scenario:8.0 contextual targeting by dv & peer 39 - zone level limitation - PART FOUR - Passback Expected
