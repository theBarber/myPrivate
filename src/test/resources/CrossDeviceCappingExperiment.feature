...
Feature: Cross Device Capping Experiment
  ...
  Scenario: 1.a  *single device*  verify line items capping enforced when sending zone requests from same user (different cookies)
...
#$$$$$$$$$$$$$$$$$$$$$$$$$ CROSS (Persona) $$$$$$$$$$$$$$$$$
#  Scenario: 1.b *cross* verify line items capping enforced when sending zone requests from same user (different cookies)
#    Given I add device 1.20qxblv735tk3q7yq7nzy8mjm with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add device 1.314dzessmqqc5lby3bhzxcxtf with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
#    When I send 3 times an ad request with parameter {optimize=1&ct=1&unlimited=1&stid=1} for zone named {INT3708-zone-zoneset-DeviceLiCapping-ST-8} to UAS
...
#    And The responses are passback
  ...
  Scenario: 2.a *single device* verify capping enforced when sending zone requests from same user (different cookies) - Delivery
    Given I add device 1.20qxblv735tk3q7yq7nzy8mjm with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
    Given I add device 1.314dzessmqqc5lby3bhzxcxtf with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
    ...
    Given I clear all cookies from uas requests
    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
    When I send 1 times an ad request with parameter {optimize=1&ct=1&unlimited=1&stid=1} for zone named {INT3708-zone-zoneset-CrossDeviceCapping-ST} to UAS
    Then The response code is 200
    And The responses are passback

#$$$$$$$$$$$$$$$$$$$$$$$$$ CROSS (Persona) $$$$$$$$$$$$$$$$$
#  Scenario: 2.b *cross* verify capping enforced when sending zone requests from same user (different cookies) - Delivery
#    Given I add device 1.20qxblv735tk3q7yq7nzy8mjm with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add device 1.314dzessmqqc5lby3bhzxcxtf with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
#    When I send 4 times an ad request with parameter {optimize=1&ct=1&unlimited=1&stid=1} for zone named {INT3708-zone-zoneset-CrossDeviceCapping-ST} to UAS
...
#    And The responses are passback
  ...
  Scenario: 3. verify campaign session capping enforced when sending zone requests from user - in time frame
  ...
  Scenario: 5.a *single device* verify campaign session capping enforced when sending zone requests from same user
    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
    And I add unlimited query parameter with value {1} to send my requests to uas
    And I add optimize query parameter with value {1} to send my requests to uas
...
#$$$$$$$$$$$$$$$$$$$$$$$$$ CROSS (Persona) $$$$$$$$$$$$$$$$$
#  Scenario: 5.b *cross* verify campaign session capping enforced when sending zone requests from same user
#    Given I add device 1.20qxblv735tk3q7yq7nzy8mjm with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add device 1.314dzessmqqc5lby3bhzxcxtf with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
#    And I add unlimited query parameter with value {1} to send my requests to uas
...
#    And The responses are passback
  ...
  Scenario: 6. verify campaign lifetime capping enforced when sending zone requests from same device
    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
    And I add unlimited query parameter with value {1} to send my requests to uas
    And I add optimize query parameter with value {1} to send my requests to uas
    ...
    #$$$$$$$$$$$$$$$$$$$$$$$$$ CROSS (Persona) $$$$$$$$$$$$$$$$$ (there is already for single device - 1.a)
#  Scenario: 7. *cross* verify campaign lifetime capping enforced when sending zone requests from same user (different cookies)
#    Given I add device 1.20qxblv735tk3q7yq7nzy8mjm with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add device 1.314dzessmqqc5lby3bhzxcxtf with record <{"user-graph": {"upid":"11111111111111111111111111111111", "devices":[{"udid":"1.20qxblv735tk3q7yq7nzy8mjm"}, {"udid":"1.314dzessmqqc5lby3bhzxcxtf"}]}}> to user info
#    Given I add cookie UTID with value {22222222222222222222222222222222} to my requests to uas
#    And I add unlimited query parameter with value {1} to send my requests to uas
...
#    And The responses are passback
  ...
  Scenario: 8. Request from browser without a cookie - verify no capping is enforced & ad is being delivered
  ...
  Scenario: 9. ** BUG Publisher capping **  header bidding frequency capping from mobile - user 1
  ...
  Scenario: 10. ** BUG Publisher capping ** header bidding frequency capping from Desktop user 1
  ...
  Scenario: 11. ** BUG Publisher capping ** header bidding frequency capping from mobile - user 2
    Given I use {Mozilla/5.0 (Linux; U; Android 4.4.2; en-us; SCH-I535 Build/KOT49H) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30} as user-agent string to send my requests to uas
  ...
  Scenario: 12. ** BUG Publisher capping ** header bidding frequency capping from Desktop user 2
  ...
  Scenario: 13. header bidding - no capping
    Given I clear all headers from uas requests
    Given I use {Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36} as user-agent string to send my requests to uas
    Given I add cookie UTID with value {44444444444444444444444444444444} to my requests to uas
    Given I add header of {x-forwarded-for} with value {207.246.116.162}
