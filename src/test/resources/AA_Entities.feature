...
#    pacing = hourly flex
  ...
  Scenario: create entities for NDQ filtering
    ...
    Given i create new campaigns, new zoneset with domains
      ...
      | NDQfilteringTL-ST-1 | 75396 | 210722   | false                 | 8290          | {zone-zoneset-NDQfilteringTL-ST-2} | []         | 93       | 15556          | 3843         | 69625           | []          | []          |
