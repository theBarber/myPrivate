...
Feature: Entities for tests
  ...
  Scenario: entities end-date update
    ...
    And i update io_line_item end date by id {234550,243710,251644,253288,253747,245653,210722,241783,223539,240827,198082,197418,224812,222908,224810,224539,240829,224533,224530,211456,228962,224531,228961,229737,243452,234550,234656,243707,243711,244895,244896,244699}
