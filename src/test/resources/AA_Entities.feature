...
#    pacing = hourly flex
  ...
  Scenario: create entities for dynamic pricing with margin
    ...
    Given i create new campaigns, new zoneset with domains
      ...
      | campaign-dpm-reserved-no-margin-MR-ES         | 407981 | 251036   | true                  | 192           | {zone-zoneset-dpm-reserved-no-margin-MR-ES}         | []         | 10       | 15355          | 3836         | 69501           | []          | []          |
      | campaign-dpm-non-reserved-no-margin-MR-ES     | 407981 | 251035   | true                  | 192           | {zone-zoneset-dpm-non-reserved-no-margin-MR-ES}     | []         | 10       | 15356          | 3836         | 69501           | []          | []          |
      | campaign-dpm-direct-margin-MR-ES              | 75396  | 249737   | false                 | 22986         | {zone-zoneset-dpm-direct-margin-MR-ES}              | []         | 10       | 15359          | 3836         | 69501           | []          | []          |
      | campaign-dpm-reserved-margin-MR-ES            | 407981 | 251036   | true                  | 192           | {zone-zoneset-dpm-reserved-margin-MR-ES}            | []         | 10       | 15360          | 3836         | 69501           | []          | []          |
      | campaign-dpm-non-reserved-margin-MR-ES        | 407981 | 251035   | true                  | 192           | {zone-zoneset-dpm-non-reserved-margin-MR-ES}        | []         | 10       | 15361          | 3836         | 69501           | []          | []          |
      | campaign-dpm-non-reserved-margin-MR-ES-mobile | 407981 | 251035   | true                  | 192           | {zone-zoneset-dpm-non-reserved-margin-MR-ES-mobile} | []         | 10       | 15362          | 3836         | 69501           | []          | []          |
