...
#    Given I add header of {x-forwarded-for} with value {207.246.116.162}
  ...
  Scenario: 6. basic Call to Programmatic GW, GW doing auction, last ad selected - Header bidding
#    Given I add header of {x-forwarded-for} with value {207.246.116.162}
    ...
    #web Burl
  Scenario: 7a. basic Call to Programmatic GW web, zone request, make sure b-url is sent
    ...
    #inApp Burl
  Scenario: 7b. basic Call to Programmatic GW InApp, zone request, make sure b-url is sent
