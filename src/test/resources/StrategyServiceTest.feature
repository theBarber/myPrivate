...
Feature: Strategy service test
  ...
  Scenario: Send an ad request to UAS and parse impression url
    ...
    And I add dma query parameter with value {787} to send my requests to uas
    ...
    Then I get for column 47 id {1001} {33%}
    And I get for column 47 id {1002} {33%}
    And I get for column 47 id {1003} {33%}
