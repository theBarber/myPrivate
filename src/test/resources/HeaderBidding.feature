...
#    And The response code is 200
#    And The response contains script
##    And all HB responses contains campaignId with id 325720
...
#    And all HB responses contains cpm with id 1
#    And i inject profile id 1 to user {crmqc31wb5vfkxdocrtwfw057} on adserver bucket
...
#    And The response code is 200
#    And The response contains script
##    And all HB responses contains campaignId with id 325719
