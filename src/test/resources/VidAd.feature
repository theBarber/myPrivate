...
Feature: video Adhsion new ad unit tests
  ...
  Scenario:1 vidAd server prog test, zone req
  ...
  Scenario:2 vidAd server prog test, DT req
  ...
  Scenario:3 vidAd base test, zone req
  ...
  Scenario:4 vidAd base test, DT req
  ...
  Scenario:5 InstreamVid, zone req, vpaid_support=0, inapp. banner without moat wrapper expected
  ...
  Scenario:6 InstreamVid, zone req, vpaid_support=0, not inapp. banner without moat wrapper expected
  ...
  Scenario:7 InstreamVid, zone req, vpaid_support=1, inapp. banner without moat wrapper expected
