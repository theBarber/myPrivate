...
Feature: UAS create campaigns for unit test
    ...
    Scenario: 1 - create campaigns with specific line item, creative, zoneset
        When I create new Campaign named {Ramp-lift-Test-direct-1} using ramp-app api's for LineItem 215959 associated to creative 960 with zoneset 67937 with priority {-1}
        ...
        When I create new Campaign named {Ramp-lift-Test-client-1} using ramp-app api's for LineItem 210671 associated to creative 959 with zoneset 67937 with priority {-1}
        ...
        When I create new Campaign named {Ramp-lift-Test-server-1} using ramp-app api's for LineItem 206146 associated to creative 959 with zoneset 67937 with priority {-1}
