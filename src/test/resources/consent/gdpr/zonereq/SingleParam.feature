...
Feature: GDPR - Zone Reqs - Europe Delivery Logic - Single Gdpr Param Is Specified In URL
  ...
  @gdpr
  @GdprTrueParamEu
  Scenario:1.0 gdpr=1 - zone request from --> Canada
  ...
  @gdpr
  @GdprFalseParamEu
  Scenario:3.0 gdpr=0 - zone request from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
  ...
  Scenario:5.0 gdprstr=UT_ID_INCLUDED_UT_PURPOSE_IDS_INCLUDED - from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
  ...
  Scenario:7.0 gdprstr=UT_ID_INCLUDED_UT_PURPOSE_IDS_EXCLUDED - from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
  ...
  Scenario:9.0 gdprstr=UT_ID_EXCLUDED_UT_PURPOSE_IDS_INCLUDED - from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
  ...
  Scenario:11.0 gdprstr=UT_ID_EXCLUDED_UT_PURPOSE_IDS_EXCLUDED - from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
  ...
  Scenario:13.0 gdprstr=empty_string -  from --> Canada
    Given I reset the http headers sent to uas
    Given I add header of {x-forwarded-for} with value {192.206.151.131}
