...
@CucumberOptions(features = "classpath:RabbitMQ_integration.feature",  plugin = { "pretty", "com.undertone.automation.RotatingJSONFormatter:target/cucumber/rabbit_$TIMESTAMP$.json" })
